...
import {
  ...
  PROFILE_SLACK_WEBHOOK_URL_MAX,
  PROFILE_EMAIL_MAX,
  PROFILE_NOTIFICATION_TIME_MAX,
  PROFILE_NOTIFICATION_QUERY_MAX
} from "@/db/limits"
...
export const ProfileSettings: FC<ProfileSettingsProps> = ({}) => {
  ...
  const [profileNotificationTime, setProfileNotificationTime] = useState(
    profile?.notification_time || ""
  )
  const [profileNotificationQuery, setProfileNotificationQuery] = useState(
    profile?.notification_query || ""
  )
  ...
  const handleSave = async () => {
    ...
    const updatedProfile = await updateProfile(profile.id, {
      ...
      slack_webhook_url: profileSlackWebhook,
      email: profileEmail,
      notification_time: profileNotificationTime,
      notification_query: profileNotificationQuery,
          ...
          <Tabs defaultValue="profile">
            ...
            <TabsContent className="mt-4 space-y-4" value="profile">
              ...
              <div className="space-y-1">
                ...
                <Input
                  placeholder="Slack WebHook URL을 입력해주세요"
                  value={profileSlackWebhook}
                  onChange={e => setProfileSlackWebHook(e.target.value)}
                  maxLength={PROFILE_SLACK_WEBHOOK_URL_MAX}
                />
              </div>
              <div className="space-y-1">
                <Label className="text-sm">
              ...
              <div className="space-y-1">
                ...
                <FormControl fullWidth>
                  <NativeSelect
                    value={profileNotificationTime}
                    onChange={e => setProfileNotificationTime(e.target.value)}
                    inputProps={{
                      name: "Time",
              ...
              <div className="space-y-1">
                ...
                <Input
                  placeholder="예: 바이오 제약 뉴스, AI 기술 뉴스 (비워두면 프로필 기반 자동 생성)"
                  value={profileNotificationQuery}
                  onChange={e => setProfileNotificationQuery(e.target.value)}
                  maxLength={PROFILE_NOTIFICATION_QUERY_MAX}
                />
                <div className="text-xs text-gray-500">
                  직접 설정한 쿼리가 우선 적용됩니다. 비워두면 프로필 컨텍스트를 기반으로 자동 생성됩니다.
                </div>
                <LimitDisplay
                  used={profileNotificationQuery.length}
                  limit={PROFILE_NOTIFICATION_QUERY_MAX}
                />
              </div>
            </TabsContent>
