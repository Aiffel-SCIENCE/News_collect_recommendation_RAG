...
('e9fc7e46-a8a5-4fd4-8ba7-af485013e6fa', 'Workspace 1', 'This is for testing.', 4000, 'gpt-4.1-nano', 'You are an assistant.', 0.5, true, true, 'These are the instructions.', false, 'private', 'openai');
...
BEGIN
  ...
  ('e9fc7e46-a8a5-4fd4-8ba7-af485013e6fa', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'private', TRUE, TRUE, 4000, 'gpt-4.1-nano', 'Preset 1', 'Prompt 1', 0.5, 'Description for Preset 1', 'openai');
  ...
  ('e9fc7e46-a8a5-4fd4-8ba7-af485013e6fa', 'Albert Einstein', 'This is an Albert Einstein assistant.', 'gpt-4.1-nano', '', 'private', 4000, TRUE, TRUE, 'You are Albert Einstein.', 0.5, 'openai');
  ...
  ('e9fc7e46-a8a5-4fd4-8ba7-af485013e6fa', workspace1_id, 'Chat 1', 'gpt-4.1-nano', 'You are an assistant.', 0.5, 4000, TRUE, TRUE, 'openai');
  ...
  BEGIN
    ...
    ('e9fc7e46-a8a5-4fd4-8ba7-af485013e6fa', workspace1_id, 'Chat 4', 'gpt-4.1-nano', 'You are an assistant.', 0.5, 4000, TRUE, TRUE, folder1_id, 'openai');
  END;
