...
export const PROFILE_SLACK_WEBHOOK_URL_MAX = 250
export const PROFILE_EMAIL_MAX = 100
export const PROFILE_NOTIFICATION_TIME_MAX = 25
export const PROFILE_NOTIFICATION_QUERY_MAX = 200
