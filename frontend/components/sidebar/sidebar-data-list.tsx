...
import { NewsChatItem } from "./items/news-chat/news-chat-item"
...
export const SidebarDataList: FC<SidebarDataListProps> = ({
  ...
  const getDataListComponent = (
    ...
    switch (contentType) {
      ...
      case "news-chats":
        return <NewsChatItem key={item.id} chat={item as Tables<"rag_chats">} />
  ...
  const getItemProps = (contentType: ContentType, item: any) => {
    switch (contentType) {
      case "chats":
        return { chat: item }
      case "news-chats":
